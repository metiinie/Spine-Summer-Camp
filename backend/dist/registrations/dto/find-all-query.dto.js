...
__decorate([
    ...
    (0, class_transformer_1.Transform)(({ value }) => typeof value === 'string' && value.toLowerCase() !== 'all' ? value.toUpperCase() : value),
    (0, class_validator_1.IsIn)(['all', 'PENDING_PAYMENT', 'RECEIPT_UPLOADED', 'UNDER_REVIEW', 'APPROVED', 'REJECTED']),
